...
import {
  ...
  Cpu, ArrowUpRight, CheckCircle2, Clock, Filter, MapPin
} from 'lucide-react';
...
export default function Home() {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        if (!selectedCommunity && data.communities.length > 0) {
          // Default selection to degraded community (e.g. Bako) for demonstration
  ...
  // Switch to simulator tab and pre-select community
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-gray-900 flex flex-col font-sans">
      ...
      <main className="flex-1 mx-auto w-full max-w-7xl p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        {/* KPI Metrics Bar (Google Material Cloud Cards) */}
        ...
        {activeTab === 'map' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Google Maps Main Container (2 cols) */}
            ...
            {/* Right Side: Telemetry Inspector & Live Citizen Stream */}
            <div className="space-y-6">
              
              {/* Selected Community Live IoT Card */}
              {selectedCommunity ? (
